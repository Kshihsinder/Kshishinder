...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register as volunteer"} primary={true} style={style} onClick={(event) => this.handleClick(event,'volunteer')}/>
       </div>
       </MuiThemeProvider>
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as elderly"} primary={true} style={style} onClick={(event) => this.handleClick(event,'elderly')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      volunteerbuttonLabel:'Register as volunteer',
      elderlybuttonLabel:'Register as elderly',
      isLogin:true
    }
  }
  componentWillMount(){
